"""Pure-function tests for app/core/localization/formatting.py.
...
def test_translate_missing_key_returns_default() -> None:
    assert translate("no.such.localization.key", default="FALLBACK") == "FALLBACK"


def test_translate_missing_key_no_default_returns_key() -> None:
    assert translate("no.such.localization.key") == "no.such.localization.key"
