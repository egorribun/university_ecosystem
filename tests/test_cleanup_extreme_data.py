...
async def test_cleanup_expired_sessions_handles_db_lock_exception() -> None:
    ...
    mock_db.execute.side_effect = OperationalError("DELETE stmt", {}, "database is locked")
...
async def test_cleanup_stale_notifications_handles_db_lock_exception() -> None:
    ...
    mock_db.execute.side_effect = OperationalError("SELECT stmt", {}, "database is locked")
