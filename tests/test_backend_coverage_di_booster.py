...
# 1. app/auth/spotify.py
def test_auth_spotify_legacy_reexport():
    assert legacy_spotify.router is not None
    assert legacy_spotify.disconnect is not None
    assert legacy_spotify.list_playlists is not None
    assert legacy_spotify.now_playing is not None
    assert legacy_spotify.spotify_auth_url is not None
    assert legacy_spotify.spotify_callback is not None
    assert legacy_spotify.sync_playlists is not None


# 2. app/core/di/search.py
@pytest.mark.asyncio
...
# 6. app/core/di/infrastructure.py
@pytest.mark.asyncio
...
# 9. app/core/exceptions/__init__.py
@pytest.mark.asyncio
...
# 12. app/core/middleware/content_size.py
@pytest.mark.asyncio
