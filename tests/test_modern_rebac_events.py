...
async def test_update_event_rebac_allowed(async_client, user_factory):
    ...
    mock_session.get.return_value = MagicMock(id=event_id, created_by=uuid.uuid4(), image_url=None)
    ...
    mock_event_service.update_event.return_value = MagicMock(id=event_id, image_url=None)
    import datetime
