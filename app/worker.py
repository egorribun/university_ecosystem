...
async def main() -> None:
    ...
    # Standalone workers do not pass through the ASGI application bootstrap;
    # install the same redacting structlog/stdlib bridge before any record is
    # emitted so PII cannot escape through the default structlog renderer.
    configure_logging()
