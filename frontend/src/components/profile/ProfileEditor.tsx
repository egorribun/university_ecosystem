          ...
          <>
            <div className="flex flex-col gap-1.5 sm:gap-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base rounded-lg sm:rounded-xl border border-glass-border bg-(--bg-surface) text-(--text-primary) placeholder:text-(--text-secondary) focus:outline-none focus:ring-2 focus:ring-(--brand-main) focus:border-transparent transition-all duration-200 resize-y min-h-[70px] sm:min-h-[80px]"
              />
            </div>
            <div className="flex flex-col gap-1.5 sm:gap-2">
              <label className="text-xs sm:text-sm font-bold text-(--text-primary)">
            ...
            <div className="flex flex-col gap-1.5 sm:gap-2">
              ...
              <textarea
                ...
                rows={2}
                className="w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base rounded-lg sm:rounded-xl border border-glass-border bg-(--bg-surface) text-(--text-primary) placeholder:text-(--text-secondary) focus:outline-none focus:ring-2 focus:ring-(--brand-main) focus:border-transparent transition-all duration-200 resize-y min-h-[50px] sm:min-h-[60px]"
              />
            </div>
          </>
        )}
