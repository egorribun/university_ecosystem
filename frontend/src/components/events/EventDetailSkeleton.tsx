...
export function EventDetailSkeleton({
  ...
  return (
    <div className="events-theme aurora-mesh relative min-h-screen w-full px-4 sm:px-6 md:px-10 lg:px-14 py-8">
      <EventsBackdrop isNarrow={isNarrow} prefersReducedMotion={prefersReducedMotion} />

      <div className="relative z-base max-w-4xl mx-auto space-y-6">
