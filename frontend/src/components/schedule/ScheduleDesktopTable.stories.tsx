...
// Wave 197 SW5 — ScheduleDesktopTable Storybook fixture (CONTEXT-tier, medium).
//
// Weekly grid table. Props are Pick<ReturnType<useScheduleData>> + display
// helpers. Wraps the real, side-effect-free <SchedulePageProvider> for
// useSchedulePage(); Zustand stores (hidden weekdays / display prefs) are global,
// no provider needed. No portal; no framer m.* (CSS-only). user=null → read-only
// (no admin add/delete affordances).
//
...
const meta: Meta<typeof ScheduleDesktopTable> = {
  title: "Schedule/ScheduleDesktopTable",
  component: ScheduleDesktopTable,
...
export default meta
type Story = StoryObj<typeof ScheduleDesktopTable>
