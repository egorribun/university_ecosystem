...
// Wave 197 SW5 — ScheduleMobileView Storybook fixture (CONTEXT-tier, medium).
//
// Mobile single-day view with swipe between days. Props are
// Pick<ReturnType<useScheduleData>> + display helpers, plus weekdayShort /
// getDayLabel / todayComplete (mobile-only). Real <SchedulePageProvider> for
// useSchedulePage(); Zustand stores global. user=null → read-only.
//
...
const meta: Meta<typeof ScheduleMobileView> = {
  title: "Schedule/ScheduleMobileView",
  component: ScheduleMobileView,
...
export default meta
type Story = StoryObj<typeof ScheduleMobileView>
