...
function WidgetPlaceholder() {
  return (
    <div className="flex h-full min-h-[60px] items-center justify-center rounded-lg bg-[color:var(--glass-bg)]/50">
      <span className="text-xs text-[color:var(--page-text)]/30">—</span>
    </div>
  )
}
