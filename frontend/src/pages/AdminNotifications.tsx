...
import { AdminNotificationsFeature } from "@/features/admin"

/**
 * AdminNotifications page — Wave 164 SW2 thin wrapper.
 *
...
export default function AdminNotifications() {
  return (
    <Layout>
      <FeatureErrorBoundary featureName="admin-notifications">
