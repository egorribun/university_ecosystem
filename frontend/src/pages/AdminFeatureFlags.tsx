...
import { AdminFeatureFlagsFeature } from "@/features/admin"

/**
 * AdminFeatureFlags page — Wave 164 SW2 thin wrapper.
 *
...
export default function AdminFeatureFlags() {
  return (
    <Layout>
      <FeatureErrorBoundary featureName="admin-feature-flags">
        <AdminFeatureFlagsFeature />
