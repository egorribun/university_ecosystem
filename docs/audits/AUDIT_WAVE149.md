...
| Build × 3 reproducible | main JS + server.js BYTE-IDENTICAL × 3 | _shell.html + sw.js size-identical but sha varies (W141 polish A3 known non-determinism in post-build-shell.mjs CSP nonce + workbox precache revision) |
...
CI run started at 2026-05-13T20:36:57Z on commit `33a01788d`. Status: in_progress at audit-write time. Expected gates per W148 baseline run `25820038217`:
