...
- backend pytest **FULL suite 2920 passed / 25 skipped / 0 failed** (W203 §H#5 — not a slice; `--ignore=tests/contracts/test_ws_hub_contract.py` for the pact-python Windows DLL)
