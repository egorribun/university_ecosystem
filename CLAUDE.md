...
- Map zoom/pan: `useMapNavigation.ts` — CSS `transform: scale() translate()` on wrapper div, wheel zoom (passive: false), pinch touch, boundary clamping. 0 deps (DESIGN-91-01)
