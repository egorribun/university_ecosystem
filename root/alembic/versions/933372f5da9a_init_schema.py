...
def upgrade() -> None:
    ...
    op.alter_column('event_attendance', 'user_id',
    ...
    op.create_index('ix_event_attendance_event_user', 'event_attendance', ['event_id', 'user_id'], unique=False)
    op.create_index(op.f('ix_event_attendance_registered_at'), 'event_attendance', ['registered_at'], unique=False)
    op.create_index(op.f('ix_event_attendance_user_id'), 'event_attendance', ['user_id'], unique=False)
    op.create_unique_constraint('uq_event_attendance_user_event', 'event_attendance', ['user_id', 'event_id'])
    op.alter_column('event_files', 'event_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.create_index(op.f('ix_event_files_event_id'), 'event_files', ['event_id'], unique=False)
    ...
    op.create_index('ix_notifications_dupe_check', 'notifications', ['user_id', 'title', 'url', 'created_at'], unique=False)
    ...
    op.alter_column('schedule', 'group_id',
               existing_type=sa.INTEGER(),
               nullable=False)
    op.alter_column('schedule', 'subject',
    ...
    op.alter_column('schedule', 'end_time',
               existing_type=postgresql.TIMESTAMP(),
               nullable=False)
    op.create_index(op.f('ix_schedule_end_time'), 'schedule', ['end_time'], unique=False)
    op.create_index(op.f('ix_schedule_group_id'), 'schedule', ['group_id'], unique=False)
    op.create_index('ix_schedule_group_start_time', 'schedule', ['group_id', 'start_time'], unique=False)
    ...
    op.create_foreign_key(None, 'schedule', 'groups', ['group_id'], ['id'], ondelete='CASCADE')
    ...
    op.alter_column('users', 'spotify_token_expires_at',
               ...
               type_=sa.DateTime(),
               existing_nullable=True)
    op.alter_column('users', 'spotify_scope',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    op.alter_column('users', 'spotify_last_checked_at',
               ...
               type_=sa.DateTime(),
               existing_nullable=True)
    op.alter_column('users', 'spotify_last_track_url',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
    op.alter_column('users', 'spotify_last_album_image_url',
               existing_type=sa.TEXT(),
               type_=sa.String(),
               existing_nullable=True)
...
def downgrade() -> None:
    ...
    op.create_index(op.f('uq_users_spotify_user_id'), 'users', ['spotify_user_id'], unique=True)
    op.alter_column('users', 'spotify_last_album_image_url',
    ...
    op.create_foreign_key(op.f('schedule_group_id_fkey'), 'schedule', 'groups', ['group_id'], ['id'])
    ...
    op.alter_column('event_files', 'event_id',
               existing_type=sa.INTEGER(),
               nullable=True)
    op.drop_constraint('uq_event_attendance_user_event', 'event_attendance', type_='unique')
    op.drop_index(op.f('ix_event_attendance_user_id'), table_name='event_attendance')
    op.drop_index(op.f('ix_event_attendance_registered_at'), table_name='event_attendance')
