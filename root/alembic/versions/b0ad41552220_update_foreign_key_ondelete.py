...
def upgrade():
    ...
    op.drop_constraint('event_attendance_event_id_fkey', 'event_attendance', type_='foreignkey')
    ...
    op.drop_constraint('invite_codes_used_by_user_id_fkey', 'invite_codes', type_='foreignkey')
    ...
    op.create_foreign_key(
        'event_attendance_user_id_fkey', 'event_attendance', 'users', ['user_id'], ['id'],
        ondelete='CASCADE'
    )
    op.create_foreign_key(
        'event_attendance_event_id_fkey', 'event_attendance', 'events', ['event_id'], ['id'],
        ondelete='CASCADE'
    )
    op.create_foreign_key(
    ...
    op.create_foreign_key(
        'news_author_id_fkey', 'news', 'users', ['author_id'], ['id'],
        ondelete='SET NULL'
    )
    op.create_foreign_key(
        'invite_codes_used_by_user_id_fkey', 'invite_codes', 'users', ['used_by_user_id'], ['id'],
        ondelete='SET NULL'
    )
