...
function AppContent() {
  ...
  const fallbackShell = (
    <div
      aria-hidden="true"
      style={{ minHeight: "100dvh", background: "var(--page-bg, var(--initial-bg, #060B14))", color: "var(--page-text)" }}
    />
  )

  const routedContent = (
    <div style={{ minHeight: "100dvh", background: "var(--page-bg, var(--initial-bg, #060B14))", color: "var(--page-text)" }}>
