...
const useNews = (id?: string) => {
  ...
  return { news, loading, reload: loadNews }
}
...
const NewsDetail = () => {
  ...
  const { news, loading, reload: loadNews } = useNews(id)

  const [editOpen, setEditOpen] = useState(false)
  const [editData, setEditData] = useState<EditState>({ title: "", content: "", image_url: "" })
