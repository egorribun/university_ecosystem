...
const DetailRow = ({ label, value }: { label: string; value?: React.ReactNode }) => {
  ...
  return (
    <div className="grid grid-cols-[12px_1fr] items-start gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 sm:py-3 min-h-[44px] sm:min-h-[48px] rounded-lg sm:rounded-xl border-2 border-[rgba(176,196,222,0.85)] dark:border-glass-border bg-[#f8fbfe]/95 dark:bg-card-bg backdrop-blur-sm transition-all duration-300 hover:shadow-[0_4px_16px_rgba(15,79,170,0.08)] hover:border-nav-link/45 dark:hover:border-glass-border/80 hover:bg-white/98 dark:hover:bg-surface-accent">
      <div className="w-1.5 h-1.5 mt-1.5 rounded-full bg-nav-link dark:bg-nav-link shadow-[0_0_0_2px_rgba(15,79,170,0.2)] dark:shadow-[0_0_0_2px_rgba(127,182,230,0.15)] justify-self-center" />
  ...
  return (
    <>
        ...
        >
          ...
          >
            <div className="max-w-full sm:max-w-[98%] md:max-w-[96%] lg:max-w-[95%] xl:max-w-[1400px] mx-auto w-full relative z-0">
              <motion.div
                ref={containerRef}
                className="profile-card px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 py-8 sm:py-10 md:py-12 lg:py-14 rounded-xl sm:rounded-2xl md:rounded-3xl relative overflow-hidden border-2 border-glass-border bg-white/65 dark:bg-card-bg backdrop-blur-md shadow-surface dark:shadow-surface-strong"
                initial={
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-[minmax(280px,380px)_minmax(0,1fr)] xl:grid-cols-[minmax(320px,420px)_minmax(0,1fr)] 2xl:grid-cols-[minmax(380px,460px)_minmax(0,1fr)] gap-x-4 sm:gap-x-6 md:gap-x-8 lg:gap-x-10 xl:gap-x-12 gap-y-6 sm:gap-y-8 lg:gap-y-0 items-start">
                  <div className="flex flex-col gap-4 sm:gap-5 md:gap-6 lg:gap-8 items-stretch">
                    ...
                    {/* Contact Panel */}
                    <div className="profile-card p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl flex flex-col gap-4 sm:gap-5 border-2 border-[rgba(176,196,222,0.85)] dark:border-glass-border bg-[#f8fbfe]/98 dark:bg-card-bg backdrop-blur-sm shadow-[0_6px_24px_rgba(15,79,170,0.08)] dark:shadow-surface-strong">
                      {/* Contact Links */}
                      <div className="flex flex-col gap-3 sm:gap-4 contact-links">
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="w-full flex flex-row items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg sm:rounded-xl border-2 border-[rgba(176,196,222,0.75)] dark:border-glass-border bg-white/92 dark:bg-card-bg backdrop-blur-sm hover:bg-white hover:shadow-[0_4px_16px_rgba(15,79,170,0.12)] dark:hover:bg-surface-accent hover:border-nav-link/45 dark:hover:border-glass-border/80 transition-all duration-200 group"
                          ...
                          {emailMenuAnchor && (
                            <div
                              ref={emailMenuRef}
                              data-email-menu
                              className="absolute left-0 top-full mt-2 z-20 min-w-[200px] overflow-hidden rounded-lg border-2 border-glass-border bg-white/90 dark:bg-card-bg shadow-surface-strong backdrop-blur-xl"
                            >
                              <button
                  ...
                  <div className="w-full relative" style={{ marginTop: isMobile ? "0" : "0" }}>
                    {edit ? (
                      <div className="profile-card profile-edit w-full rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 border-2 border-glass-border bg-white/60 dark:bg-card-bg backdrop-blur-sm shadow-surface dark:shadow-surface-strong">
                                  ...
                                  <div className="grid grid-cols-[repeat(auto-fit,minmax(120px,1fr))] sm:grid-cols-[repeat(auto-fit,minmax(140px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-2.5 sm:gap-3">
                                    {achievementsList.map((ach, idx) => (
                                      <motion.button
                                        ...
                                        className="px-3 sm:px-4 py-2 sm:py-2.5 md:py-3 rounded-lg sm:rounded-xl border-2 border-[rgba(176,196,222,0.8)] dark:border-glass-border bg-[#f8fbfe]/95 dark:bg-card-bg backdrop-blur-sm hover:bg-white hover:shadow-[0_6px_20px_rgba(15,79,170,0.15)] dark:hover:bg-surface-accent hover:border-nav-link/45 dark:hover:border-glass-border/80 text-page-foreground font-bold text-xs sm:text-sm leading-tight transition-all duration-300 hover:scale-105 cursor-pointer text-left"
                                      >
                                        {ach.name}
                                      </motion.button>
                                    ))}
      ...
      <Dialog
        ...
        PaperProps={{
          className:
            "!rounded-xl sm:!rounded-2xl border-2 border-glass-border bg-white/95 dark:bg-card-bg backdrop-blur-md shadow-surface dark:shadow-surface-strong",
        }}
      >
        ...
        <DialogContent className="flex flex-col items-center justify-center gap-3 min-h-[320px] p-6">
          <div className="bg-white p-4 rounded-2xl border-2 border-[#0f4faa]/25 shadow-[0_18px_40px_-28px_rgba(15,79,170,0.35)]">
            <QRCodeSVG
              value={buildVCard()}
              size={300}
              level="H"
