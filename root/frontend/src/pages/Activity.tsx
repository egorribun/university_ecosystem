                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      period === option.value
                        ...
                        : "bg-transparent text-[#000000] hover:bg-[color:color-mix(in_srgb,var(--nav-link)_12%,transparent)] hover:text-[color:var(--nav-link)] dark:bg-[color:color-mix(in_srgb,white_8%,transparent)] dark:text-white dark:hover:bg-[color:color-mix(in_srgb,white_12%,transparent)]"
                    )}
                  >
                    {option.label}
                  </button>
