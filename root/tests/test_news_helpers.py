...
def test_localized_text_prefers_requested_locale_with_fallbacks():
    ...
    assert news._localized_text("en", ru_value="Русский", en_value="English") == "English"
    ...
    assert news._localized_text(DEFAULT_LOCALE, ru_value="Русский", en_value="English") == "English"
